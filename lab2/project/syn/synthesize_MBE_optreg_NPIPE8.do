...
analyze -f vhdl -lib WORK ../tb/simconsts_NPIPE8.vhd
...
report_resources > reports/multiplier_MBE/report_resources_opt_reg_npipe8.txt
report_area > reports/multiplier_MBE/report_area_opt_reg_npipe8.txt
report_area -hierarchy > reports/multiplier_MBE/report_area_hier_opt_reg_npipe8.txt
report_timing > reports/multiplier_MBE/report_timing_opt_reg_npipe8.txt
