...
analyze -f vhdl -lib WORK ../tb/simconsts_stage2_pipelined.vhd
...
report_resources > reports/multiplier_stage2_pipelined/report_resources_opt_reg.txt
report_area > reports/multiplier_stage2_pipelined/report_area_opt_reg.txt
report_timing > reports/multiplier_stage2_pipelined/report_timing_opt_reg.txt


### Synthesize with compile_ultra
remove_design -designs
...
report_resources > reports/multiplier_stage2_pipelined/report_resources_ultra.txt
report_area > reports/multiplier_stage2_pipelined/report_area_ultra.txt
report_timing > reports/multiplier_stage2_pipelined/report_timing_ultra.txt


### Synthesize with compile_ultra -retime
remove_design -designs
...
report_resources > reports/multiplier_stage2_pipelined/report_resources_ultra_retime.txt
report_area > reports/multiplier_stage2_pipelined/report_area_ultra_retime.txt
report_timing > reports/multiplier_stage2_pipelined/report_timing_ultra_retime.txt
