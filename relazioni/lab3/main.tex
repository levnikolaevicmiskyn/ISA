...
\title{
	...
	{\large Report for Lab 3}\\
	 {\small \url{https://github.com/levnikolaevicmiskyn/ISA/tree/main/lab3}} \\ \ \\
...
\include{3-verification/verification}
\include{4-synthesis/synthesis}
\include{5-conclusion/conclusion}
\include{6-appendix/appendix}
\end{document}
